# Source = https://docs.microsoft.com/en-us/openspecs/windows_protocols/ms-erref/596a1078-e883-4972-9bbc-49e60bebca55
...
# ,--- From other sources:
  0xC00001AD: "STATUS_FAILFAST_OOM_EXCEPTION",
# `---
...
# ,--- There is a conflict here! Python will pick one or the other.
# | to make sure both will be defined, they are both defined in mWindowsConstantDefines too.
