...
class iNumericDataBaseType(iDataBaseType):
  def __lt__(oSelf, xOther):
    return oSelf.value < (xOther.value if isinstance(xOther, iNumericDataBaseType) else xOther);
  ...
  def __divmod__(oSelf, xOther):
    return divmod(oSelf.value, (xOther.value if isinstance(xOther, iNumericDataBaseType) else xOther));
  def __pow__(oSelf, xOther, xModulo = None):
    return pow(
      oSelf.value,
      (xOther.value if isinstance(xOther, iNumericDataBaseType) else xOther),
      (xModulo.value if isinstance(xModulo, iNumericDataBaseType) else xModulo)
    );
  ...
  def __rpow__(oSelf, xOther):
    return pow(oSelf.value, (xOther.value if isinstance(xOther, iNumericDataBaseType) else xOther));
  ...
  def __iadd__(oSelf, xOther):
    oSelf.value = oSelf.value + (xOther.value if isinstance(xOther, iNumericDataBaseType) else xOther);
    return oSelf.value;
