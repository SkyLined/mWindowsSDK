...
POWER_REQUEST_CONTEXT_SIMPLE_STRING     = 0x00000001; # https://docs.microsoft.com/en-us/windows/win32/api/minwinbase/ns-minwinbase-reason_context
POWER_REQUEST_CONTEXT_DETAILED_STRING   = 0x00000002;
POWER_REQUEST_CONTEXT_VERSION           =          0; 
PowerRequestDisplayRequired             =          0; # https://docs.microsoft.com/en-us/windows-hardware/drivers/ddi/wdm/ne-wdm-_power_request_type
